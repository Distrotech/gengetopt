/*
  File autogenerated by gengetopt version 2.18rc
...
const char *gengetopt_args_info_help[] = {
  ...
  "  \n  The parser generated is thought to be used to parse the command line \n  arguments.  However, you can also generate parsers for configuration files, \n  or strings that contain the arguments to parse, by using the following two \n  options.\n",
  "  -C, --conf-parser           generate a config file parser",
  "  -S, --string-parser         generate a string parser (the string contains the \n                                command line)",
  "  ",
  "  -G, --include-getopt        adds the code for getopt_long in the generated C \n                                file",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->func_name_help = gengetopt_args_info_help[3] ;
  args_info->arg_struct_name_help = gengetopt_args_info_help[4] ;
  args_info->file_name_help = gengetopt_args_info_help[5] ;
  args_info->output_dir_help = gengetopt_args_info_help[6] ;
  args_info->c_extension_help = gengetopt_args_info_help[7] ;
  args_info->header_extension_help = gengetopt_args_info_help[8] ;
  args_info->long_help_help = gengetopt_args_info_help[9] ;
  args_info->unamed_opts_help = gengetopt_args_info_help[10] ;
  args_info->conf_parser_help = gengetopt_args_info_help[11] ;
  args_info->string_parser_help = gengetopt_args_info_help[12] ;
  args_info->include_getopt_help = gengetopt_args_info_help[13] ;
  args_info->no_handle_help_help = gengetopt_args_info_help[14] ;
  args_info->no_handle_version_help = gengetopt_args_info_help[15] ;
  args_info->no_handle_error_help = gengetopt_args_info_help[16] ;
  args_info->gen_version_help = gengetopt_args_info_help[17] ;
  args_info->set_package_help = gengetopt_args_info_help[18] ;
  args_info->set_version_help = gengetopt_args_info_help[19] ;
  args_info->show_help_help = gengetopt_args_info_help[20] ;
  args_info->show_full_help_help = gengetopt_args_info_help[21] ;
  args_info->show_version_help = gengetopt_args_info_help[22] ;
