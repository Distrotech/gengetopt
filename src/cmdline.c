...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->no_handle_help_help = gengetopt_args_info_help[11] ;
  args_info->no_handle_version_help = gengetopt_args_info_help[12] ;
  args_info->no_handle_error_help = gengetopt_args_info_help[13] ;
  args_info->gen_version_help = gengetopt_args_info_help[14] ;
  args_info->conf_parser_help = gengetopt_args_info_help[15] ;
  args_info->string_parser_help = gengetopt_args_info_help[16] ;
  args_info->include_getopt_help = gengetopt_args_info_help[17] ;
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVi:f:a:F:c:H:lu::nNegCSG", long_options, &option_index);
