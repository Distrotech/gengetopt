/*
  File autogenerated by gengetopt version 2.22b
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->func_name_help = gengetopt_args_info_help[5] ;
  args_info->arg_struct_name_help = gengetopt_args_info_help[6] ;
  args_info->file_name_help = gengetopt_args_info_help[7] ;
  args_info->output_dir_help = gengetopt_args_info_help[8] ;
  args_info->c_extension_help = gengetopt_args_info_help[9] ;
  args_info->header_extension_help = gengetopt_args_info_help[10] ;
  args_info->long_help_help = gengetopt_args_info_help[11] ;
  args_info->default_optional_help = gengetopt_args_info_help[12] ;
  args_info->unamed_opts_help = gengetopt_args_info_help[13] ;
  args_info->conf_parser_help = gengetopt_args_info_help[15] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->input_given)
    write_into_file(outfile, "input", args_info->input_orig);
  if (args_info->func_name_given)
    write_into_file(outfile, "func-name", args_info->func_name_orig);
  if (args_info->arg_struct_name_given)
    write_into_file(outfile, "arg-struct-name", args_info->arg_struct_name_orig);
  if (args_info->file_name_given)
    write_into_file(outfile, "file-name", args_info->file_name_orig);
  if (args_info->output_dir_given)
    write_into_file(outfile, "output-dir", args_info->output_dir_orig);
  if (args_info->c_extension_given)
    write_into_file(outfile, "c-extension", args_info->c_extension_orig);
  if (args_info->header_extension_given)
    write_into_file(outfile, "header-extension", args_info->header_extension_orig);
  if (args_info->long_help_given)
    write_into_file(outfile, "long-help", 0 );
  if (args_info->default_optional_given)
    write_into_file(outfile, "default-optional", 0 );
  if (args_info->unamed_opts_given)
    write_into_file(outfile, "unamed-opts", args_info->unamed_opts_orig);
  if (args_info->conf_parser_given)
    write_into_file(outfile, "conf-parser", 0 );
  if (args_info->string_parser_given)
    write_into_file(outfile, "string-parser", 0 );
  ...
  if (args_info->show_required_given)
    write_into_file(outfile, "show-required", args_info->show_required_orig);
  if (args_info->gen_version_given)
    write_into_file(outfile, "gen-version", 0 );
  if (args_info->set_package_given)
    write_into_file(outfile, "set-package", args_info->set_package_orig);
  if (args_info->set_version_given)
    write_into_file(outfile, "set-version", args_info->set_version_orig);
  if (args_info->show_help_given)
    write_into_file(outfile, "show-help", 0 );
  if (args_info->show_full_help_given)
    write_into_file(outfile, "show-full-help", 0 );
  if (args_info->show_detailed_help_given)
    write_into_file(outfile, "show-detailed-help", 0 );
  if (args_info->show_version_given)
    write_into_file(outfile, "show-version", 0 );
