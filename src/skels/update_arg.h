...
class update_arg_gen_class
{
 ...
 public:
  update_arg_gen_class() :
    flag_arg (false), float_arg (false), has_arg (false), int_arg (false), long_arg (false), longlong_arg (false), no_free (false), numeric (false), string_arg (false)
  {
  }
  
  update_arg_gen_class(const string &_cast, bool _flag_arg, bool _float_arg, bool _has_arg, bool _int_arg, bool _long_arg, bool _longlong_arg, bool _no_free, bool _numeric, const string &_opt_var, const string &_optarg, const string &_orig_optarg, const string &_package_var_name, bool _string_arg, const string &_structure) :
    cast (_cast), flag_arg (_flag_arg), float_arg (_float_arg), has_arg (_has_arg), int_arg (_int_arg), long_arg (_long_arg), longlong_arg (_longlong_arg), no_free (_no_free), numeric (_numeric), opt_var (_opt_var), optarg (_optarg), orig_optarg (_orig_optarg), package_var_name (_package_var_name), string_arg (_string_arg), structure (_structure)
  {
  }
  ...
  void set_numeric(bool _numeric)
  {
    numeric = _numeric;
  }
