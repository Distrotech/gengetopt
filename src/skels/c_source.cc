...
c_source_gen_class::generate_c_source(ostream &stream, unsigned int indent)
{
  ...
  stream << "\n";
  stream << indent_str;
  stream << "#define GENGETOPT_(S) dgettext (gengetopt_client_domain (), S)";
  stream << "\n";
  stream << indent_str;
  stream << "#define GENGETOPT_N(S1, S2, N) dngettext (gengetopt_client_domain (), S1, S2, N)";
  stream << "\n";
  stream << indent_str;
  stream << "#else";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "gengetopt_client_domain()";
  stream << "\n";
  stream << indent_str;
  stream << "{";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  const char *domain = \"gengetopt-client\";";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  stream << "  /* before first use, bind gengetopt's client message domain to the path that";
  stream << "\n";
  stream << indent_str;
  stream << "   * gengetopt was configured to use for its l10n strings */";
  stream << "\n";
  stream << indent_str;
  stream << "  if (!bind_done) {";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  int i, skip, count, column = start_column;";
  stream << "\n";
  stream << indent_str;
  stream << "  const char *word = NULL;";
  stream << "\n";
  stream << indent_str;
  stream << "  int word_len = 0;";
  stream << "\n";
  stream << indent_str;
  stream << "  char in_word;";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "		  print_chars( word, word_len );";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
