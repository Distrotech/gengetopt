...
c_source_gen_class::generate_c_source(ostream &stream, unsigned int indent)
{
  ...
  stream << "\n";
  stream << indent_str;
  stream << "#ifdef HAVE_GETTEXT";
  stream << "\n";
  stream << indent_str;
  stream << "#include <libintl.h>";
  stream << "\n";
  stream << indent_str;
  stream << "#define _(S) gettext (S)";
  stream << "\n";
  stream << indent_str;
  stream << "#define GENGETOPT_(S) gengetopt_gettext (S)";
  stream << "\n";
  stream << indent_str;
  stream << "#define GENGETOPT_N(S1, S2, N) gengetopt_ngettext (S1, S2, N)";
  stream << "\n";
  stream << indent_str;
  stream << "#else";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "#define GENGETOPT_(S) S";
  stream << "\n";
  stream << indent_str;
  stream << "#define GENGETOPT_N(S1, S2, N) ((N) == 1? (S1) : (S2))";
  stream << "\n";
  stream << indent_str;
  stream << "#endif";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "static const char *gengetopt_gettext_domain = \"gengetopt-client\";";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  ...
  stream << "\n";
  stream << indent_str;
  stream << "gengetopt_ensure_gettext_bound()";
  stream << "\n";
  stream << indent_str;
  stream << "{";
  stream << "\n";
  stream << indent_str;
  stream << "  static char bind_done = 0;";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  stream << "  /* bind gengetopt's client message domain to the path that gengetopt was";
  stream << "\n";
  stream << indent_str;
  stream << "   * configured to use for its l10n strings; we must always work in utf-8 so";
  stream << "\n";
  stream << indent_str;
  stream << "   * that we can manipulate strings */";
  stream << "\n";
  stream << indent_str;
  stream << "  if (!bind_done) {";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "    bindtextdomain (gengetopt_gettext_domain, \"";
  generate_string (locale_dir, stream, indent + indent_str.length ());
  stream << "\");";
  stream << "\n";
  stream << indent_str;
  stream << "    bind_textdomain_codeset (gengetopt_gettext_domain, \"UTF-8\");";
  stream << "\n";
  stream << indent_str;
  stream << "  }";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "gengetopt_gettext (const char *str )";
  stream << "\n";
  stream << indent_str;
  stream << "{";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  return dgettext (gengetopt_gettext_domain, str);";
  stream << "\n";
  stream << indent_str;
  stream << "}";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "gengetopt_ngettext (const char *str1, const char *str2, unsigned long int n)";
  stream << "\n";
  stream << indent_str;
  stream << "{";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  return dngettext (gengetopt_gettext_domain, str1, str2, n);";
  stream << "\n";
  stream << indent_str;
  stream << "}";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "print_spaces (int len);";
  stream << "\n";
  stream << indent_str;
  stream << "static void";
  stream << "\n";
  stream << indent_str;
  stream << "print_wrapped_string (const char *str, int start_column, int indent);";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  ...
  stream << "                        struct ";
  generate_string (parser_name, stream, indent + indent_str.length ());
  stream << "_params *params, const char *error_location);";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  if (check_required_options)
    {
      ...
      generate_string (args_info, stream, indent + indent_str.length ());
      stream << " *args_info, const char *prog_name, const char *error_location);";
      stream << "\n";
      stream << indent_str;
    }
  if (cmd_list)
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  static char already_done = 0;";
  stream << "\n";
  stream << indent_str;
  stream << "  if( already_done )";
  stream << "\n";
  stream << indent_str;
  stream << "    return;";
  stream << "\n";
  stream << indent_str;
  stream << "  already_done = 1;";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  ...
  indent = 2;
  stream << "  ";
  if (init_strings.size () > 0)
    generate_string (init_strings, stream, indent + indent_str.length ());
  else
    generate_init_strings (stream, indent + indent_str.length ());
  indent = 0;
  stream << "\n";
  stream << indent_str;
  stream << "}";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "print_name_and_version_common (void)";
  stream << "\n";
  stream << indent_str;
  stream << "{";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  print_name_and_version_common();";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  ...
  stream << "\n";
  stream << indent_str;
  stream << "      print_wrapped_string( ";
  generate_string (args_info, stream, indent + indent_str.length ());
  stream << "_versiontext, 0, 0 );";
  stream << "\n";
  stream << indent_str;
  stream << "      printf( \"\\n\" );";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  static int column = 0;";
  stream << "\n";
  stream << indent_str;
  stream << "  if( column )";
  stream << "\n";
  stream << indent_str;
  stream << "    return column;";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  indent = 2;
  stream << "  ";
  if (calculate_desc_column.size () > 0)
    generate_string (calculate_desc_column, stream, indent + indent_str.length ());
  else
    generate_calculate_desc_column (stream, indent + indent_str.length ());
  indent = 0;
  stream << "\n";
  stream << indent_str;
  stream << "  return column;";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "static size_t";
  stream << "\n";
  stream << indent_str;
  stream << "count_initial_newlines (const char *str, int *count)";
  stream << "\n";
  stream << indent_str;
  stream << "{";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  for( skip = 0; str[ skip ]; skip++ ) {";
  stream << "\n";
  stream << indent_str;
  stream << "    if( str[ skip ] == '\\r' )";
  stream << "\n";
  stream << indent_str;
  stream << "      continue;";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "print_chars (const char *str, int len)";
  stream << "\n";
  stream << indent_str;
  stream << "{";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  int i, count, column = start_column;";
  stream << "\n";
  stream << indent_str;
  stream << "  size_t skip;";
  stream << "\n";
  stream << indent_str;
  stream << "  const char *word = NULL;";
  stream << "\n";
  stream << indent_str;
  stream << "  int word_len;";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  const char *str_end = str + strlen (str);";
  stream << "\n";
  stream << indent_str;
  stream << "  mbstate_t mbstate;";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  stream << "  memset (&mbstate, 0, sizeof (mbstate_t));";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  ...
  stream << "\n";
  stream << indent_str;
  stream << "	  column = start_column + indent;";
  stream << "\n";
  stream << indent_str;
  stream << "	  print_spaces( column );";
  stream << "\n";
  stream << indent_str;
  stream << "	  continue;";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "      /* find next word (including preceeding spaces) */";
  stream << "\n";
  stream << indent_str;
  stream << "      in_word = 0;";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "      while( *str && ( *str != ' ' || !in_word ) && *str != '\\r' && *str != '\\n' )";
  stream << "\n";
  stream << indent_str;
  stream << "        {";
  stream << "\n";
  stream << indent_str;
  stream << "	  in_word = *str != ' '? 1 : 0;";
  stream << "\n";
  stream << indent_str;
  stream << "	  word_len++;";
  stream << "\n";
  stream << indent_str;
  stream << "	  skip = mbrlen (str, str_end - str, &mbstate);";
  stream << "\n";
  stream << indent_str;
  stream << "	  if (skip == (size_t)-1 || skip == (size_t)-2)";
  stream << "\n";
  stream << indent_str;
  stream << "	    break;";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "          /* wrapping required? */";
  stream << "\n";
  stream << indent_str;
  stream << "	  column += word_len;";
  stream << "\n";
  stream << indent_str;
  stream << "	  if( column > 80 )";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "		  print_spaces( start_column + indent );";
  stream << "\n";
  stream << indent_str;
  stream << "		  print_chars( word, str - word );";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  stream << "		  column = start_column + indent + word_len;";
  stream << "\n";
  stream << indent_str;
  stream << "		}";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "print_help_list_element (const char *header, const char *text,";
  stream << "\n";
  stream << indent_str;
  stream << "			 const char *extra)";
  stream << "\n";
  stream << indent_str;
  stream << "{";
  stream << "\n";
  stream << indent_str;
  stream << "  const int param_padding = 2;";
  stream << "\n";
  stream << indent_str;
  stream << "  const int desc_column = calculate_desc_column();";
  stream << "\n";
  stream << indent_str;
  stream << "  int column = 0;";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "      print_wrapped_string( header, 0, 0 );";
  stream << "\n";
  stream << indent_str;
  stream << "      printf( \"\\n\" );";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "      print_spaces( param_padding );";
  stream << "\n";
  stream << indent_str;
  stream << "      print_wrapped_string( text, param_padding, 0 );";
  stream << "\n";
  stream << indent_str;
  stream << "      if( *extra )";
  stream << "\n";
  stream << indent_str;
  stream << "        column = param_padding + strlen( text );";
  stream << "\n";
  stream << indent_str;
  stream << "      if( !*extra || column > desc_column - param_padding )";
  stream << "\n";
  stream << indent_str;
  stream << "        {";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "      if( column < desc_column )";
  stream << "\n";
  stream << indent_str;
  stream << "	print_spaces( desc_column - column );";
  stream << "\n";
  stream << indent_str;
  stream << "      print_wrapped_string( extra, desc_column, 2 );";
  stream << "\n";
  stream << indent_str;
  stream << "      printf( \"\\n\" );";
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "    print_help_list_element( ";
  generate_string (args_info, stream, indent + indent_str.length ());
  stream << "_help[ i ],";
  stream << "\n";
  stream << indent_str;
  ...
  stream << "\n";
  stream << indent_str;
  stream << "      fprintf (stderr, GENGETOPT_(\"%s: cannot dump options to stream\\n\"), ";
  generate_string (package_var_name, stream, indent + indent_str.length ());
  stream << ");";
  stream << "\n";
  stream << indent_str;
  ...
  stream << "\n";
  stream << indent_str;
  stream << "      fprintf (stderr, GENGETOPT_(\"%s: cannot open file for writing: %s\\n\"), ";
  generate_string (package_var_name, stream, indent + indent_str.length ());
  stream << ", filename);";
  stream << "\n";
  stream << indent_str;
  ...
  if (multiple_options)
    {
      ...
      stream << "\n";
      stream << indent_str;
      stream << "		      \"%s: %s option must occur once\\n\",";
      stream << "\n";
      stream << indent_str;
      stream << "		      \"%s: %s option must occur %d times\\n\", min),";
      stream << "\n";
      stream << indent_str;
      ...
      stream << "\n";
      stream << indent_str;
      stream << "	      fprintf (stderr, GENGETOPT_(";
      stream << "\n";
      stream << indent_str;
      stream << "		  \"%s: %s option must occur between %d and %d times\\n\"),";
      stream << "\n";
      stream << indent_str;
      ...
      stream << "\n";
      stream << indent_str;
      stream << "	          \"%s: %s option must occur at least once\\n\",";
      stream << "\n";
      stream << indent_str;
      stream << "		  \"%s: %s option must occur at least %d times\\n\", min),";
      stream << "\n";
      stream << indent_str;
      stream << "                prog_name, option_desc, min);";
      stream << "\n";
      ...
      stream << "\n";
      stream << indent_str;
      stream << "	          \"%s: %s option must occur at most once\\n\",";
      stream << "\n";
      stream << indent_str;
      stream << "		  \"%s: %s option must occur at most %d times\\n\", max),";
      stream << "\n";
      stream << indent_str;
  ...
  stream << "  result = ";
  generate_string (parser_name, stream, indent + indent_str.length ());
  stream << "_internal (argc, argv, args_info, params, \"\");";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  ...
  if (check_required_options)
    {
      ...
      stream << "  if (";
      generate_string (parser_name, stream, indent + indent_str.length ());
      stream << "_required2(args_info, prog_name, \"\") > 0)";
      stream << "\n";
      stream << indent_str;
  ...
  if (( ! no_options ))
    {
      ...
      stream << " * ";
      stream << "@";
      stream << "param error_location string that identifies the error's location";
      stream << "\n";
      stream << indent_str;
      stream << " */";
      stream << "\n";
      ...
      stream << "\n";
      stream << indent_str;
      stream << "               const char *error_location)";
      stream << "\n";
      stream << indent_str;
      stream << "{";
      stream << "\n";
      ...
      stream << "\n";
      stream << indent_str;
      stream << "	fprintf (stderr, GENGETOPT_(\"%s%s: `--%s' (`-%c') option given more \"";
      stream << "\n";
      stream << indent_str;
      stream << "				    \"than once\\n\"),";
      stream << "\n";
      stream << indent_str;
      stream << "		 package_name, error_location, long_opt, short_opt);";
      stream << "\n";
      stream << indent_str;
      stream << "      else";
      stream << "\n";
      stream << indent_str;
      stream << "	fprintf (stderr, GENGETOPT_(\"%s%s: `--%s' option given more than \"";
      stream << "\n";
      stream << indent_str;
      stream << "				    \"once\\n\"),";
      stream << "\n";
      stream << indent_str;
      stream << "		 package_name, error_location, long_opt);";
      stream << "\n";
      stream << indent_str;
      ...
      if (check_possible_values)
        {
          ...
          stream << "\n";
          stream << indent_str;
          stream << "	  fprintf (stderr, GENGETOPT_(\"%s%s: ambiguous argument, \\\"%s\\\", for \"";
          stream << "\n";
          stream << indent_str;
          stream << "				      \"option `--%s' (`-%c')\\n\"),";
          stream << "\n";
          stream << indent_str;
          stream << "		   package_name, error_location, value, long_opt, short_opt);";
          stream << "\n";
          stream << indent_str;
          stream << "	else";
          stream << "\n";
          ...
          stream << "\n";
          stream << indent_str;
          stream << "		   package_name, error_location, value, long_opt);";
          stream << "\n";
          stream << indent_str;
          stream << "      else";
          stream << "\n";
          ...
          stream << "\n";
          stream << indent_str;
          stream << "	  fprintf (stderr, GENGETOPT_(\"%s%s: invalid argument, \\\"%s\\\", for \"";
          stream << "\n";
          stream << indent_str;
          stream << "				      \"option `--%s' (`-%c')\\n\"),";
          stream << "\n";
      ...
      if (( ( ( ( ( ( has_arg_int || has_arg_short ) || has_arg_long ) || has_arg_float ) || has_arg_double ) || has_arg_longdouble ) || has_arg_longlong ))
        {
          ...
          stream << "\n";
          stream << indent_str;
          stream << "      fprintf(stderr, GENGETOPT_(\"%s: invalid numeric value: %s\\n\"),";
          stream << "\n";
          stream << indent_str;
          stream << "	      package_name, val);";
          stream << "\n";
          stream << indent_str;
          stream << "      return 1; /* failure */";
          stream << "\n";
  ...
  if (multiple_token_functions)
    {
      ...
      stream << "\n";
      stream << indent_str;
      stream << "          arg_type, 0, 1, 1, 1, long_opt, short_opt, error_location)) {";
      stream << "\n";
      stream << indent_str;
  ...
  if (has_modes)
    {
      ...
      stream << "\n";
      stream << indent_str;
      stream << "          fprintf(stderr, GENGETOPT_(\"%s: option %s conflicts with option \"";
      stream << "\n";
      stream << indent_str;
      stream << "				     \"%s\\n\"),";
      stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "          fprintf (stderr, GENGETOPT_(\"%s%s: option unknown: %c\\n\"),";
  stream << "\n";
  stream << indent_str;
  stream << "		   ";
  generate_string (package_var_name, stream, indent + indent_str.length ());
  stream << ", error_location, c);";
  stream << "\n";
  stream << indent_str;
  stream << "          abort ();";
  stream << "\n";
  ...
  if (conf_parser)
    {
      ...
      stream << "\n";
      stream << indent_str;
      stream << "      fprintf (stderr, GENGETOPT_(\"%s: Error opening configuration file \"";
      stream << "\n";
      stream << indent_str;
      stream << "				  \"'%s'\\n\"),";
      stream << "\n";
      ...
      stream << "\n";
      stream << indent_str;
      stream << "  location = (char *) malloc (strlen (filename) + 42);";
      stream << "\n";
      stream << indent_str;
      ...
      stream << "\n";
      stream << indent_str;
      stream << "	  sprintf (location_lineno, \"%d\", line_num);";
      stream << "\n";
      stream << indent_str;
      stream << "	  fprintf (stderr, GENGETOPT_(\"%s%s: Line too long in \"";
      stream << "\n";
      stream << indent_str;
      ...
      stream << "\n";
      stream << indent_str;
      stream << "	          \"%s%s: unterminated string in configuration file\\n\"),";
      stream << "\n";
      stream << indent_str;
      stream << "		";
      generate_string (package_var_name, stream, indent + indent_str.length ());
      ...
      stream << "\n";
      stream << indent_str;
      stream << "	          \"%s%s: malformed string in configuration file\\n\"),";
      stream << "\n";
      stream << indent_str;
      stream << "		";
      generate_string (package_var_name, stream, indent + indent_str.length ());
      ...
      stream << "\n";
      stream << indent_str;
      stream << "	      \"%s%s: include requires a filename argument.\\n\"),";
      stream << "\n";
      stream << indent_str;
      stream << "	    ";
      generate_string (package_var_name, stream, indent + indent_str.length ());
      ...
      stream << "\n";
      stream << indent_str;
      stream << "    error_location = (char *)malloc(strlen(filename) + 2);";
      stream << "\n";
      stream << indent_str;
      stream << "    error_location[0] = ':';";
      stream << "\n";
      stream << indent_str;
      stream << "    strcpy (&error_location[1], filename);";
      stream << "\n";
      stream << indent_str;
      stream << "    result =";
      stream << "\n";
      ...
      stream << "\n";
      stream << indent_str;
      stream << "                              params, error_location);";
      stream << "\n";
      stream << indent_str;
      stream << "\n";
      stream << indent_str;
      stream << "    free (error_location);";
      stream << "\n";
      stream << indent_str;
  ...
  if (generate_string_parser)
    {
      ...
      stream << "    ";
      generate_string (parser_name, stream, indent + indent_str.length ());
      stream << "_internal (argc, argv_ptr, args_info, params, \"\");";
      indent = 0;
      stream << "\n";
      stream << indent_str;
      indent = 2;
