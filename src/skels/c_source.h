...
class c_source_gen_class
{
 ...
 public:
  ...
  virtual void generate_calculate_desc_column(ostream &stream, unsigned int indent) = 0;

  void set_calculate_desc_column(const string &_calculate_desc_column)
  {
    calculate_desc_column = _calculate_desc_column;
  }
  ...
  virtual void generate_init_strings(ostream &stream, unsigned int indent) = 0;

  void set_init_strings(const string &_init_strings)
  {
    init_strings = _init_strings;
  }
  ...
  void set_locale_dir(const string &_locale_dir)
  {
  ...
  void set_usage_wrap_column(int _usage_wrap_column)
  {
    usage_wrap_column = _usage_wrap_column;
  }
