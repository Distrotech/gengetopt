...
gengetopt_option::gengetopt_option() :
    short_opt(0), long_opt(0), desc(0), type(ARG_NO), flagstat(-1),
            required(1), required_set(false), 
            var_arg(0), default_string(0), group_value(0),
            group_desc(0), multiple(false), arg_is_optional(false),
            hidden(false), type_str(0), acceptedvalues(0), section(0),
            section_desc(0), dependon(0), text_before(0), text_after(0),
